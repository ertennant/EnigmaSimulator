...
export default function ConfigPanel({currentConfig, configOptions, onChangeConfig, onCancel}: ConfigPanelProps) {
  ...
  return (
    <form 
      ...
      >
      <label htmlFor="reflector" className="font-[Roboto] col-span-1 row-span-1 row-start-1 col-start-1 text-center text-white content-center">Reflector</label>
      <select name="reflector" defaultValue={currentConfig.reflector} className="font-[Roboto_Mono] text-white col-span-1 row-span-1 col-start-1 row-start-2">
      ...
      <p className="font-[Roboto] text-white row-start-1 col-start-2 text-center content-center col-span-3">Rotors</p>
